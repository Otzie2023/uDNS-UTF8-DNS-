...
pub struct ZonesFile {
    ...
    pub dnssec_zsk_file: Option<String>,
    pub dnssec_key_file: Option<String>,
    pub dnssec_ksk_file: Option<String>,
}
...
pub struct ZoneEntry {
    ...
    pub dnssec_key_file: Option<String>,
    pub dnssec_ksk_file: Option<String>,
    #[serde(rename = "ZSK-public")]
    pub zsk_public: Option<String>,
    #[serde(rename = "ZSK-private")]
    pub zsk_private: Option<String>,
    #[serde(rename = "KSK-public")]
    pub ksk_public: Option<String>,
    #[serde(rename = "KSK-private")]
    pub ksk_private: Option<String>,
}
